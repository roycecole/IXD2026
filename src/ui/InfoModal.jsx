    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal" onClick={(e) => e.stopPropagation()}>
        ...
        <ul className="modal-list">
          ...
          <li><b>真實資料</b>：右側選水庫或「花蓮外海（潮汐）」；按「播放 24h 資料」讓球隨真實資料起伏（可倍速、循環，畫面上方顯示資料時刻）。滿庫 / 滿潮 ＝ 海水滿球、液體從球緣溢出。背景銀河濃度＝河川即時水位、球外鳥群＝該流域鳥類調查鳥種數（隨現實季節增減）；選「花蓮外海（潮汐）」背景會出現月亮，盈虧與位置對應當日月齡與時刻。</li>
