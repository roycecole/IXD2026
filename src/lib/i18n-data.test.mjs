...
const ZH_DESCRIBE = {
    "tide@A": [
      ...
      "鳥群｜曾文溪流域 9 月 79 種（內插） → 3 群 · 調查 2004–2015（空窗 2005–2013）",
      "魚群｜南化水庫樣點（曾文溪流域） 9 月 32 種（內插） · 調查 2004–2006（空窗 2005）",
    ...
    "tide@A month1": [
      ...
      "月亮｜上弦月 · 月齡 9.2 天",
      "氣象｜多雲午後短暫雷陣雨 · 25.5°C · 濕度 70% · 風 3.2 m/s → 洋流 0.30",
      "鳥群｜曾文溪流域 2 月 84 種 → 3 群 · 調查 2004–2015（空窗 2005–2013）",
      "魚群｜南化水庫樣點（曾文溪流域） 2 月 30 種 · 調查 2004–2006（空窗 2005）",
      "河川｜2 站即時水位 · 平均警戒比 0.55 → 銀河濃度",
      "測站｜河川流量站 188 站（現存 100）→ 星座",
    ],
    "res-full@B": [
    ...
    "dust-valid@A": [
      ...
      "氣象｜多雲午後短暫雷陣雨 · 25.5°C · 濕度 70% · 風 3.2 m/s",
      "鳥群｜曾文溪流域 9 月 79 種（內插） → 3 群 · 調查 2004–2015（空窗 2005–2013）",
      "魚群｜南化水庫樣點（曾文溪流域） 9 月 32 種（內插） · 調查 2004–2006（空窗 2005）",
      "河川｜2 站即時水位 · 平均警戒比 0.55 → 銀河濃度",
      "測站｜河川流量站 188 站（現存 100）→ 星座",
    ...
    "moon-stale@C": [
      ...
      "氣象｜多雲午後短暫雷陣雨 · 25.5°C · 濕度 70% · 風 3.2 m/s",
      "鳥群｜曾文溪流域 6 月 77 種（內插） → 3 群 · 調查 2004–2015（空窗 2005–2013）",
      "魚群｜南化水庫樣點（曾文溪流域） 6 月 29 種（內插） · 調查 2004–2006（空窗 2005）",
      "河川｜2 站即時水位 · 平均警戒比 0.55 → 銀河濃度",
      "測站｜河川流量站 188 站（現存 100）→ 星座",
    ],
    "moon-none@A": [
...
const ZH_LOG = [
    ...
    "資料 鳥群｜曾文溪流域 9 月 79 種（內插） → 3 群 · 調查 2004–2015（空窗 2005–2013）",
    "資料 魚群｜南化水庫樣點（曾文溪流域） 9 月 32 種（內插） · 調查 2004–2006（空窗 2005）",
...
const EN_DESCRIBE = {
    "tide@A": [
      ...
      "Bird flocks | Zengwen River basin · Sep: 79 species (interpolated) → 3 flocks · survey 2004–2015 (no survey 2005–2013)",
      "Fish schools | Nanhua Reservoir sites (Zengwen River basin) · Sep: 32 species (interpolated) · survey 2004–2006 (no survey 2005)",
    ...
    "tide@A month1": [
      ...
      "Moon | First quarter · moon age 9.2 days",
      "Weather | Cloudy with brief afternoon thundershowers · 25.5°C · humidity 70% · wind 3.2 m/s → current 0.30",
      "Bird flocks | Zengwen River basin · Feb: 84 species → 3 flocks · survey 2004–2015 (no survey 2005–2013)",
      "Fish schools | Nanhua Reservoir sites (Zengwen River basin) · Feb: 30 species · survey 2004–2006 (no survey 2005)",
      "Rivers | 2 live water-level gauges · avg. alert ratio 0.55 → Milky Way density",
      "Stations | River flow gauging stations: 188 (100 active) → constellation",
    ],
    "res-full@B": [
    ...
    "dust-valid@A": [
      ...
      "Weather | Cloudy with brief afternoon thundershowers · 25.5°C · humidity 70% · wind 3.2 m/s",
      "Bird flocks | Zengwen River basin · Sep: 79 species (interpolated) → 3 flocks · survey 2004–2015 (no survey 2005–2013)",
      "Fish schools | Nanhua Reservoir sites (Zengwen River basin) · Sep: 32 species (interpolated) · survey 2004–2006 (no survey 2005)",
      "Rivers | 2 live water-level gauges · avg. alert ratio 0.55 → Milky Way density",
      "Stations | River flow gauging stations: 188 (100 active) → constellation",
    ...
    "moon-stale@C": [
      ...
      "Weather | Cloudy with brief afternoon thundershowers · 25.5°C · humidity 70% · wind 3.2 m/s",
      "Bird flocks | Zengwen River basin · Jun: 77 species (interpolated) → 3 flocks · survey 2004–2015 (no survey 2005–2013)",
      "Fish schools | Nanhua Reservoir sites (Zengwen River basin) · Jun: 29 species (interpolated) · survey 2004–2006 (no survey 2005)",
      "Rivers | 2 live water-level gauges · avg. alert ratio 0.55 → Milky Way density",
      "Stations | River flow gauging stations: 188 (100 active) → constellation",
    ],
    "moon-none@A": [
...
const EN_LOG = [
    ...
    "DATA Bird flocks | Zengwen River basin · Sep: 79 species (interpolated) → 3 flocks · survey 2004–2015 (no survey 2005–2013)",
    "DATA Fish schools | Nanhua Reservoir sites (Zengwen River basin) · Sep: 32 species (interpolated) · survey 2004–2006 (no survey 2005)",
